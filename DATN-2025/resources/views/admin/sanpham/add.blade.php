    ...
    <div id="genCollapse" class="accordion-collapse collapse show" aria-labelledby="genInfo" data-bs-parent="#settingsAccordion">
        <div style="display: flex; justify-content: space-between;" class="accordion-body">
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8">
                        ...
                        <button style="border-radius: 3px;"  class="btn btn-primary" type="submit">Save Changes</button>
            </div>
            ...
            <div class="field">
            <div class="control">
                <button style="border-radius: 3px;"  type="button" id="add-size-button" class="button blue mb-3 custom-add-size">
