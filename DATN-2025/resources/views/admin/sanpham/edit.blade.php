...
<section class="section main-section">
    <div class="card mb-6">
      <header class="card-header">
        ...
        <a href="{{ route('sanpham.index') }}" class="btn-success" style="min-width:110px;padding:6px 12px;font-size:15px;margin-right:12px;margin-top:8px;height:36px;display:flex;align-items:center;">
      ...
      <div class="card-content">
        <div class="form-flex">
            ...
            <form action="{{ route('sanpham.update', ['id' => $sanpham->id]) }}" method="POST" enctype="multipart/form-data" class="form-left">
                ...
                <div class="field-wrapper col-xl-7 col-lg-7 col-md-7 col-sm-7 col-7">
            ...
            <div class="form-right">
                ...
                <div class="field-wrapper">
                    ...
                    <div style="border: 2px dashed #ccc; border-radius: 10px; width: 520px;  "  class="product-gallery control icons-left">
