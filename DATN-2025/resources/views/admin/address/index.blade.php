                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button type="button" class="btn-edit-diachi" data-id="{{ $item->id }}" data-name="{{ $item->name }}" data-shipping_fee="{{ $item->shipping_fee }}" style="background:none;border:none;cursor:pointer;">
                                                                ...
                                                                <a href="{{ route('address.delete', ['id' => $item->id]) }}" onclick="return confirm('Bạn có chắc chắn muốn xóa ?')"  data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
